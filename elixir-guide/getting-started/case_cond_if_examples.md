...
...(4)> end
"This will match"
iex(5)> "Clauses can have guards. Anonymous functions can also have guards"
...
iex(8)> function.(0)
3.0
iex(9)> "Cond allows you to check different conditions, finding the first one that does not evaluate to nil/false"
